...
public class DriversAdapter2 extends FirestoreRecyclerAdapter<Drivers, DriversAdapter2.ViewHolder> {
    ...
    public DriversAdapter2(Context mContext, FirestoreRecyclerOptions<Drivers> options) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull final ViewHolder holder, final int position, @NonNull final Drivers model) {
        ...
        holder.assign.setText("Track Driver");
